...
INSERT INTO DEPARTMENT (d_department_name) (SELECT department_nm FROM proj_stg);
...
(SELECT proj_stg.Emp_ID, JOBS.j_job_id, DEPARTMENT.d_department_key, LOCATION.l_location_key, proj_stg.start_dt, proj_stg.end_dt, EMPLOYEE.e_employee_key
                      ...
                      LEFT JOIN EMPLOYEE ON proj_stg.manager=EMPLOYEE.e_empl_name
                     );
                     
                     
INSERT INTO SALARY (SELECT POSITION.p_job_position_id, A.salary from (SELECT proj_stg.Emp_ID, JOBS.j_job_id, proj_stg.salary 
